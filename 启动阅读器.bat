...
echo [..]   检查依赖与模块...
"%PY%" -c "import utils.pdf_parser, utils.table_finder, utils.metadata, utils.metadata_compare, utils.grobid_client, utils.image_extractor, utils.translator" 1>nul 2>nul
if errorlevel 1 (
