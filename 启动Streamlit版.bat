...
title 科研文献 PDF 智能阅读器（Streamlit 版·对照）

rem ============================================================================
rem  一键启动（Streamlit 版 = 旧界面，仅作对照）：GROBID（可选） + Streamlit
rem
rem  ★ 正式版是网页版：请双击「启动阅读器.bat」（端口 8765）。本文件保留是因为
rem    两台前端共用同一个引擎（utils/）与同一份 .cache/，某些功能可在这里对照验证。
rem
